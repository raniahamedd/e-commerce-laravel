<x-front-layout title="Cart">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-md-2 col-12">
                            <div class="count-input">
                                <input class="form-control item-quantity" data-id="{{ $item->id }}" value="{{ $item->quentity }}">
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-12">
                            <p>{{ Currency::format($item->quentity * $item->product->price) }}</p>
                        </div>
                        <div class="col-lg-2 col-md-2 col-12">
    ...
    <script src="{{ asset('build/assets/cart.69d16c62.js') }}"></script>
    @endpush
